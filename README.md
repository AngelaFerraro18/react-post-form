...
L'endpoint ci restituirà delle risposte a seconda se c'è stato un successo o un fallimento, che stamperemo in console. 

## Bonus

Aggiungere un alert per comunicare all'utente il successo o il fallimento del processo.
